...
var ADD_TODO = exports.ADD_TODO = 'add_todos_item';
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(15), __webpack_require__(41)(module)))
...
var todos = function todos() {
	...
	switch (action.type) {
		...
		case _constant.TOGGLE_TODO:
			return [].concat(_toConsumableArray(state.slice(0, action.payload)), [Object.assign({}, state[action.index], {
				completed: true
...
var visibilityFilter = function visibilityFilter(visible, action) {
	if (action.type === _constant.SET_VISIBILITY_FILTER) {
...
exports.default = todoApp = (0, _redux.combineReducer)({
	todos: todos,
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_AddTodo2.default, {
					onAddClick: function onAddClick(text) {
						return dispatch((0, _action.addItem)(text));
					}
				}),
				_react2.default.createElement(_TodoList2.default, {
					todos: visibleTodos,
					onTodoClick: function onTodoClick(index) {
						return dispatch((0, _action.toggleTodo)(index));
					}
				}),
...
App.propTypes = {
	visibleTodos: _react.PropTypes.arrayOf(PropsTypes.shape({
...
exports.setVisibilityFilter = exports.toggleTodo = exports.addItem = undefined;
...
var toggleTodo = exports.toggleTodo = function toggleTodo(index) {
	return {
		type: _constant.TOGGLE_TODO,
		payload: index
	};
};
...
var setVisibilityFilter = exports.setVisibilityFilter = function setVisibilityFilter(filter) {
	return {
		type: _constant.SET_VISIBILITY_FILTER,
		payload: filter
	};
};
...
var AddTodo = function (_Components) {
	_inherits(AddTodo, _Components);
